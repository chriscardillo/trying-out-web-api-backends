...
secure_site <- "http://localhost:5000/site/secure"
```
...
update_username(a_user_token, "yeter")
...
new_token <- update_password_response$data$updateUser$token
